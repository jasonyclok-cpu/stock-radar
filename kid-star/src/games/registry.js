...
export const GAMES = [
  ...
  { id: 'story', cat: 'learn', title: '故事小劇場', emoji: '🎬', desc: '睇動畫故事,邊播邊學,睇完答題!', cost: 0, from: 'from-pink-400', to: 'to-rose-500' },
  { id: 'arcade-mul', cat: 'learn', title: '乘數表王', emoji: '✖️', desc: '乘數表鬥快背,越背越熟!', cost: 0, from: 'from-red-400', to: 'to-orange-500', arcade: { topics: ['乘法表', '乘法表(3、4)', '乘法表(6、7、8、9)'], title: '乘數表王' } },
